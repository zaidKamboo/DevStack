        ...
        <div className="min-h-screen flex items-center justify-center bg-black text-white px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          shadow-[0_0_40px_rgba(34,197,94,0.2)]"
                >
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-gray-400 text-xs sm:text-sm mt-2">
                            Start analyzing your GitHub profile today
                        </p>
                    </div>
                    ...
                    <form className="space-y-4 sm:space-y-5">
                        ...
                        <div className="relative">
                            <FiUser className="absolute left-3 top-3.5 text-green-400" />
                            <input
                                type="text"
                                placeholder="Full Name"
                                className="w-full pl-10 pr-3 py-2.5 sm:py-3 text-sm sm:text-base 
                bg-black/60 border border-green-500/20 rounded-lg 
                focus:border-green-400 focus:ring-1 focus:ring-green-500 outline-none"
                            />
                        </div>
                ...
                focus:border-green-400 focus:ring-1 focus:ring-green-500 outline-none"
                        ...
                        {/* GITHUB USERNAME */ }
                        <div className="relative">
                            <FaGithub className="absolute left-3 top-3.5 text-green-400" />
                            <input
                                type="text"
